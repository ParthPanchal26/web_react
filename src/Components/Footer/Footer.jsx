            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/ParthPanchal26"
                                ...
                                <li>
                                <a
                                        href="https://www.linkedin.com/in/parth-panchal-0abaa1268/"
                                        className="hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2024
                        <a href="https://www.linkedin.com/in/parth-panchal-0abaa1268/" className="hover:underline">
                            parthpanchal
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <Link to="https://github.com/ParthPanchal26" className="text-gray-500">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
